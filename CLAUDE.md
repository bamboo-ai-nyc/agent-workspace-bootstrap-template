...
This file is the org-level instruction slot. Claude Code and Claude Cowork load it as shared context for agents that run from this repo. Keep it concise and high-signal.
